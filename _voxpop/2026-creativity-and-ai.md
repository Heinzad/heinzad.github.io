...
For example, the mere thought of using AI in a creative writing exercise prompted this author to write a short story as least as bad as any that might be returned by the current generation of Large Language Models.  
